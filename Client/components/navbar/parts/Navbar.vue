<template>
  <b-navbar-nav>
      ...
      <b-nav-item-dropdown text="Vue d'ensemble">
        <b-dropdown-item v-if="isAdmin" :to="{ name: 'indexEvents'}">Événements</b-dropdown-item>
      ...
      <b-nav-item-dropdown text="Ajouter">
        <b-dropdown-item v-if="isAdmin" :to="{ name: 'addEvent'}">Événement</b-dropdown-item>
        <b-dropdown-item v-if="isAdmin" :to="{ name: 'addStudent'}">Étudiant</b-dropdown-item>
        <b-dropdown-item v-if="isAdmin" :to="{ name: 'addProject'}">Projet</b-dropdown-item>
        <b-dropdown-item v-if="isAdmin" :to="{ name: 'addUser'}">Utilisateur</b-dropdown-item>
